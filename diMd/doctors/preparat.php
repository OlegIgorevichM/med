    ...
    <div class="hero-container w-container">
        <div class="div-block-11">
            <div id="preparat" class="preparatd w-node-_23706b24-4560-a8db-b8ea-02857b60da92-aac01113">
                <div class="w-form">
                    <form action="../form/form-add-preparate.php" id="wf-form-FormAddPrep" name="wf-form-FormAddPrep" data-name="FormAddPrep" method="post">
            ...
            <div id="deletePrep" class="deleteprep w-node-_0cc924bb-a2fe-35fd-06ff-cd1af090a263-aac01113">
                <div class="w-form">
                    <form action="../form/form-del-prep.php" id="email-form" name="email-form" data-name="Email Form" method="post"><label for="name"
