                        ...
                        <div class="abc scroll">
                            <table width="93%" class="sub-table scrolldown" border="0">
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <a class="non-style-link" href="form-resept-adm.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Показать все рецепты &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
