    ...
    <div class="hero-container w-container">
        ...
        <div class="div-block-13">
            <div id="poiskPats" class="w-form">
                <form action="./form-search.php" id="FormPoiskP" name="wf-form-FormPoisk" data-name="FormPoisk"
                      method="post"
                      class="FormPoiskP">
        ...
        <div class="div-rab">
            <div>
                <div class="w-form">
                    ...
                    <form action="./form-update-petient.php" id="email-form" name="email-form" data-name="Email Form"
                          method="post">
                        <label style="font-size: 18px; color: rgb(49, 49, 49); font-weight: bold; font-family: Arial;">Фамилия</label>
        ...
        ';
                    ...
                    <form action="./resept.php" method="post">
                        ...
                        <script>
                            ...
                            function saveFile() {
                                ...
                                let blob = new Blob([
                                        ...
                                        "\nКоличество приемов в день: " + n + " раз"],
                                    {type: "text/plain"});
                        ...
                        <input hidden name="myregion" id="myregion" type="text"
                               value="">
                ...
                <script>
                    ...
                    s1.onchange = function () {
                        ...
                        myregion = this.value;
                        if (myregion != -1) {
                            for (var i = 0; i < (array2[myregion].length); i++) {
                                s2.innerHTML += '<option value="' + (i + 1) + '">' + array2[myregion][i]['disease'] + '</option>';
                            }
                        } else {
                            s2.disabled = true;
                            s3.disabled = true;
                    ...
                    s2.onchange = function () {
                        ...
                        var mycite = this.value;
                        if (mycite != -1) {
                            for (var i = 0; i < array3[mycite].length; i++) {
                                s3.innerHTML += '<option value="' + (array3[mycite][i]['id_table_group_of_medicines']) + '">' + array3[mycite][i]['name_group_of_medicines'] + '</option>';
                            }
                        } else {
                            s3.disabled = true;
                        }
                    ...
                    s3.onchange = function () {
                        ...
                        myp = this.value;
                        if (myp != -1) {
                            for (var i = 0; i < array4[myp].length; i++) {
                                if (array5[array4[myp][i]['constrain']])
                                    s4.innerHTML += '<option disabled value="' + (i) + '">' + array4[myp][i]['name_preparation'] + '</option>';
                                else
                                    s4.innerHTML += '<option value="' + (i) + '">' + array4[myp][i]['name_preparation'] + '</option>';
                            }
                        } else {
                            s4.disabled = true;
                        }
