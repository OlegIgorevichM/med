...
<head>
    ...
    <link href="https://uploads-ssl.webflow.com/645500de3bd98b20d3d42f98/css/medical-dose.webflow.9566243c7.css"
...
<div class="hero-section home-page-hero wf-section">
    <div data-collapse="medium" data-animation="default" data-duration="400" data-easing="ease" data-easing2="ease"
        ...
        <div class="w-container">
            <nav role="navigation" class="nav-menu w-nav-menu"><a href="#" class="nav-link w-nav-link">новый пациент</a><a
    ...
    if ($database->connect_error){
        die("Connection failed:  ".$database->connect_error);
                ...
                <div class="dash-body">
                    <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                        <tr >
                            ...
                            <td>
                                ...
                                <form action="" method="post" class="header-search">
                                    ...
                                    $list11 = $database->query("select  name_preparation from Table_Preparation;");
                        ...
                        if($_POST){
                            ...
                            $sqlmain= "select * from Table_Preparation where name_preparation ='$keyword' or name_preparation like '$keyword%' or name_preparation like '%$keyword' or name_preparation like '%$keyword%' ";
                        }else{
                            $sqlmain= "select * from Table_Preparation order by id_table_preparation desc";
                        ...
                        <tr>
                            <td colspan="4">
                                <center>
                                    ...
                                    <a class="non-style-link" href="test.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Показать все препараты &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
            ...
            if($_GET){
                ...
                $id=$_GET["id"];
                $action=$_GET["action"];
                $sqlmain= "select * from Table_Preparation where id_table_preparation='$id'";
                $result= $database->query($sqlmain);
                $row=$result->fetch_assoc();
                $name=$row["name_preparation"];
            ...
            <div id="popup1" class="overlay">
                    <div class="popup">
                    <center>
                        <a class="close" href="test.php">&times;</a>
                        <div class="content">
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td colspan="2">
                                    <a href="test.php"><input type="button" value="OK" class="login-btn btn-primary-soft btn" ></a>
